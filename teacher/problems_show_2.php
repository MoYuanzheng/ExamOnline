...
<div id="fill">
    <table class="table table-hover" style="">
        ...
        <tr style="min-width: 50px;">
            <th>
                ...
                <div class="dropdown-menu">
                    <a class="dropdown-item" href="problems_show.php">选择题</a>
        ...
        <?php
        include('../conn.php');
        $sql = "SELECT * FROM problems WHERE type = '2' order by num;";
                    ...
                    <tr>
                        ...
                        <td>
                            <div class=\"btn-group\">
                                ...
                                data-num='$num' data-item='$item' data-ans='$ans' data-exp='$exp' >修改</a>
